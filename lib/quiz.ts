...
export const PERSONALITIES: Record<BadgeKey, Personality> = {
  prof: {
    ...
    emoji: "⚡",
    title: "AI Architect",
    description: "Deeply integrating AI workflows and agents directly into your startup stack.",
    strength: "AI Adoption & Systems Architecture",
    opportunity: "Scale AI Automations",
    color: "#f4c748",
  },
  topper: {
    key: "topper",
    emoji: "🚀",
    title: "Speed Builder",
    description: "Rapidly validating MVPs, prompt experiments, and shipping fast to real users.",
    strength: "Practical Execution & Prototyping",
    opportunity: "Deepen Systematic Automations",
    color: "#34d399",
  },
  glober: {
    key: "glober",
    ...
    description: "Big AI vision and market intuition. Focus on turning ideas into repeatable proof.",
  ...
  dcp: {
    ...
    description: "Actively exploring modern AI tools, prompt patterns, and finding the right fit.",
    strength: "Continuous Learning & Curiosity",
    opportunity: "Build & Test First AI Prototype",
    color: "#c084fc",
  },
};
